...
Submissions: *January 27, 2020*

Notifications: February 27, 2020
...
Information Retrieval · Recommender Systems · Data and Algorithmic Bias ·
Fairness
...
We solicit contributions in topics related to algorithmic bias in search
and recommendation, focused (but not limited) to:

·  Data Set Collection and Preparation:

o Managing imbalances and inequalities within data sets

o Devising collection pipelines that lead to fair and unbiased data sets

o Collecting data sets useful for studying potential biased and unfair
situations

o Designing procedures for creating synthetic data sets for research
on bias and
fairness

·   Countermeasure Design and Development:

o Conducting exploratory analysis that uncover biases

o Designing treatments that mitigate biases (e.g., popularity bias
 mitigation)

o Devising interpretable search and recommendation models

o Providing treatment procedures whose outcomes are easily interpretable

o Balancing inequalities among different groups of users or stakeholders

·  Evaluation Protocol and Metric Formulation:

o Conducting quantitative experimental studies on bias and unfairness

o Defining objective metrics that consider fairness and/or bias

o Formulating bias-aware protocols to evaluate existing algorithms

o Evaluating existing strategies in unexplored domains
