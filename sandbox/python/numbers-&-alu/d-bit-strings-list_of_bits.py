...
print("isinstance(k, str), or bin(random.getrandbits(7)), is:",isinstance(k, str),"=")
print("--------------------------------------------------")
m = random.getrandbits(7)
print("m = random.getrandbits(7) is:",random.getrandbits(7),"=")
print("isinstance(m, int) is:",isinstance(m, int),"=")